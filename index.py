...
# --- VERCEL WEBHOOK ---
# Telegram sends each update to this HTTP endpoint.
...
def home():
    return "Telegram subscription bot is running on Vercel."


# --- EXPIRY ENDPOINT ---
# This can be called by an external scheduler/cron service.
@app.route("/api/expire", methods=["GET", "POST"])
def expire_users():
